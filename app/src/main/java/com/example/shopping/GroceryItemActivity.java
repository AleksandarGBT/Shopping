...
public class GroceryItemActivity extends AppCompatActivity implements AddReviewDialog.AddReview {
    ...
    public void onAddReviewResult(Review review) {
        ...
        Utils.changeUserPoint(this, incomingItem, 3); //+3 poeni za Review
        ...
        firstStarRelLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (incomingItem.getRate() != 1) {
                    ...
                    Utils.changeUserPoint(GroceryItemActivity.this, incomingItem, (1-incomingItem.getRate())*2); //za namalvanje na zvezdicka -2 poeni od prethodno so imal proizvodot
        ...
        secondStarRelLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (incomingItem.getRate() != 2) {
                    ...
                    Utils.changeUserPoint(GroceryItemActivity.this, incomingItem, (2-incomingItem.getRate())*2); //za namalvanje na zvezdicka -2 poeni od prethodno so imal proizvodot
        ...
        thirdStarRelLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (incomingItem.getRate() != 3) {
                    ...
                    Utils.changeUserPoint(GroceryItemActivity.this, incomingItem, (3-incomingItem.getRate())*2); //za namalvanje na zvezdicka -2 poeni od prethodno so imal proizvodot
