...
import com.example.shopping.DatabaseFiles.ReviewsConverter;
...
public class GroceryItem implements Parcelable {
    ...
    private int rate;
    private int userPoint; // 1poen za poseten, 2 za rangiran so zvezdi, 3 za review, 4 za kupen, 1 za pobaran preku search i 1 za citan po minuta
    private int popularityPoint; //rasti pri kupen proizvod
