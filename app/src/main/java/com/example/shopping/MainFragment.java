...
public class MainFragment extends Fragment {
    ...
    private void initRecViews() {
        ...
        if (null != newItems){
            Comparator<GroceryItem> newItemsComparator = new Comparator<GroceryItem>() { // za prikaz na items najnovite prvi
                @Override
            ...
            Comparator<GroceryItem> reverseComparator = Collections.reverseOrder(newItemsComparator); // ako ne naprajme reverse ke gi dava obratno, vo rastecki redosled po id
        ...
        if (null != popularItems){
            Comparator<GroceryItem> popularItemsComparator = new Comparator<GroceryItem>() { // za prikaz na items najnovite prvi
                @Override
                public int compare(GroceryItem o1, GroceryItem o2) {
                    return o1.getPopularityPoint() - o2.getPopularityPoint(); //finta: mozi o2-o1 i bez reverseComparator ama popravilno e kako sto e
                }
            };
        ...
        if (null != suggestedItems) {
            Comparator<GroceryItem> suggestedItemsComparator = new Comparator<GroceryItem>() { // za prikaz na items najnovite prvi
                @Override
                public int compare(GroceryItem o1, GroceryItem o2) {
                    return o1.getUserPoint() - o2.getUserPoint(); //finta: mozi o2-o1 i bez reverseComparator ama popravilno e kako sto e
                }
            };
